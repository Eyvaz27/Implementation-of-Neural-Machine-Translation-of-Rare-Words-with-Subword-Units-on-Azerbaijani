# # # Following code snippets from: https://github.com/Derek-Gong/hsoftmax/blob/master/wenet/utils/huffman_tree.py
...
def build_huffman_tree_from_tokenizer(tokenizer, text_dataloader, save_dir):
    
    tokenid_counter = Counter()
    for sample_sentence in text_dataloader.values:
        for idx in tokenizer.encode(sample_sentence.lower()).ids:
            tokenid_counter[int(idx)] += 1
