# # # Following code snippets from: https://github.com/Derek-Gong/hsoftmax/blob/master/wenet/transformer/hsoftmax_layer.py
...
from .hsoftmax_processpool import ProcessPool, Worker
